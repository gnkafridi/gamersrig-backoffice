        ...
        @if($billPhone)
          <div class="cust-row" style="display:table; width:100%; margin-bottom:8px;">
            ...
            <div style="display:table-cell; vertical-align:middle;">
              ...
              <div style="font-size:12px; font-weight:bold; color:#141414;">{{ $billPhone }}</div>
            </div>
          </div>
        @endif
        @if($billAddress || $billCity)
          <div class="cust-row" style="display:table; width:100%;">
            ...
            <div style="display:table-cell; vertical-align:middle;">
              ...
              <div style="font-size:12px; font-weight:bold; color:#141414;">{{ trim(($billAddress ?? '') . ', ' . ($billCity ?? ''), ', ') }}</div>
            </div>
          </div>
        @endif
      </td>
